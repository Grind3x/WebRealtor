...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:250px;" id="mySidebar">
    ...
    <a class="w3-bar-item w3-button w3-teal" href="/add.jsp">Add apartment</a>
...
<div class="w3-main" style="margin-left:250px;">
    ...
    <div class="w3-container" style="padding:32px">
        ...
        <form action="/add" method="post" action="/reg">
            <table>
                <tr>
                    <td><label for="numberofrooms">Number of rooms:</label></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><input type="number" name="cost" value="" id="cost"></td>
                </tr>
                <tr>
